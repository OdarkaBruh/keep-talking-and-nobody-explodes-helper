...
import {reloadWiresCollection} from "../../pages/WiresVertical.tsx";
import {LanguageContext} from "../../pages/Controller.tsx";

import {textLinkToInstruction, textReloadButton, toggleLanguage} from "../LanguageController.tsx";
    ...
    return(
        <div className='Sidebar__body'>
            ...
            <div className='sidebar__footer'>
                <div className='reloadButton' onClick={
